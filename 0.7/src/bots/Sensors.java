...
public class Sensors {
	...
	/* GETS DIST FROM BOT TO LED */
	protected double getDistanceTo(LED led) {
		double xDiff = this.getXPos() - led.getPosX();         
		double yDiff = this.getYPos() - led.getPosY();     
		double dist = Math.sqrt(xDiff*xDiff + yDiff*yDiff); 
		return dist;
	}
	...
	protected double getXGoal(){ return yGoal; }
	protected double getYGoal(){ return yGoal; }
