...
public class CustomListener implements MouseListener, MouseMotionListener, KeyListener {
	...
	public void keyTyped(KeyEvent e) {
		...
		case '2':
			...
			break;
		case '3':
			//switch LEDs ON/OFF of selected bot
			botCanvas.switchSelectedBotLED();
			break;
		case '4':
			//adds a line target under the mouse, -5 to center the targets on the mouse
			botCanvas.addLineTarget(mouseX, mouseY);
			break;
		}
	}
