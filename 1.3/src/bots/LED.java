...
public class LED {
	...
	public void render(Graphics g, Color c) {		
		...
		g.drawOval(LEDXCenter-LEDRadius, LEDYCenter-LEDRadius, LEDSize, LEDSize);
	...
	public double getCharge() { 
		...
		case "green":
			return 0.1D;
		case "blue":
			// for some shapes, bots must not be as afraid to get as close to the bots already connected
			return 0.01D;
		default:
			// LED is off
			return 0.0D;
